...
Data? jsonLdParser({required Parser parser, required Data parentData, required bool debug}) {
  ...
  if (element == null || element.isEmpty) {
    printLog("JSON+LD Parser: Element not found!", debug, color: LogColor.red);
    return null;
  }
  ...
  List results = [];
  List<Element> selector = document.querySelectorAll('script[type="application/ld+json"]');
  ...
  printLog("JSON+LD Parser: No data found!", debug, color: LogColor.orange);
  return null;
}

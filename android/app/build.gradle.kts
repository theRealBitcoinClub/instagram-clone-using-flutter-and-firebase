...
val flutterVersionCode = localProperties.getProperty("flutter.versionCode")?.toInt() ?: 2025091302
val flutterVersionName = localProperties.getProperty("flutter.versionName") ?: "2.3.1-BCH"
...
android {
    ...
    defaultConfig {
        ...
        versionCode = 2025091302
        versionName = "2.3.1-BCH"
    }

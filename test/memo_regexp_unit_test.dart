...
void main() {
  group('MemoRegExp Unit Tests', () {
    ...
    test('Static extractUrls should extract URLs', () {
      ...
      expect(
        MemoRegExp.extractUrlsRefined(result[7]),
        contains("https://free-bch.fullstack.cash/ipfs/view/bafkreieujaprdsulpf5uufjndg4zeknpmhcffy7jophvv7ebcax46w2q74"),
      );
      expect(
        MemoRegExp.extractUrlsRefined(result[8]),
        contains("https://free-bch.fullstack.cash/ipfs/view/bafkreieujaprdsulpf5uufjndg4zeknpmhcffy7jophvv7ebcax46w2q746"),
      );
      expect(
        MemoRegExp.extractUrlsRefined(result[9]),
        contains("https://free-bch.fullstack.cash/ipfs/view/bafkreieujaprdsulpf5uufjndg4zeknpmhcffy7jophvv7ebcax46w2q745?x=p"),
      );
      expect(
      ...
      expect(
        MemoRegExp.extractUrlsRefinedExtensions(MemoRegExp.extractUrlsRefined(result[7])),
        contains("https://free-bch.fullstack.cash/ipfs/view/bafkreieujaprdsulpf5uufjndg4zeknpmhcffy7jophvv7ebcax46w2q74"),
      );
      expect(
        MemoRegExp.extractUrlsRefinedExtensions(MemoRegExp.extractUrlsRefined(result[8])),
        contains("https://free-bch.fullstack.cash/ipfs/view/bafkreieujaprdsulpf5uufjndg4zeknpmhcffy7jophvv7ebcax46w2q746"),
      );
      expect(
        MemoRegExp.extractUrlsRefinedExtensions(MemoRegExp.extractUrlsRefined(result[9])),
        contains("https://free-bch.fullstack.cash/ipfs/view/bafkreieujaprdsulpf5uufjndg4zeknpmhcffy7jophvv7ebcax46w2q745?x=p"),
      );

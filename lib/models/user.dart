class User {
  ...
  User({required this.id, required this.userName, required this.fullName, required this.avatar});

  factory User.lucky() => User(
    id: "63a27531b866ce0016f9e582",
    fullName: "Lucky Ebere",
    userName: "crazelu",
    avatar: "https://github.githubassets.com/images/modules/profile/achievements/quickdraw-default.png",
  );
  ...
  factory User.billy() => User(
    ...
    fullName: "Vecna Finn",
    userName: "billy",
    avatar: "https://github.githubassets.com/images/modules/profile/achievements/yolo-default.png",
  );
  ...
  factory User.anon() => User(
    ...
    userName: "anon",
    avatar: "https://github.githubassets.com/images/modules/profile/achievements/pair-extraordinaire-default.png",
  );

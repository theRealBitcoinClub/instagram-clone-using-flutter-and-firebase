...
class WhitelistMediaDomains {
  ...
  static const String domains = r'https?://(?:[a-zA-Z0-9-]+\.)*(?:read\.cash|mahakka\.com|therealbitcoin\.club|memo\.cash|bmap\.app|bitcoinmap\.cash|yayalla\.com|papunto\.com)(?::\d+)?/[^\s]*(?:\?[^\s]*)?';
  ...
  static const String github = r'https?://(?:[a-zA-Z0-9-]+\.)*github(?:usercontent)?\.com/[^\s]*(?:\?[^\s]*)?';
  static const String gitlab = r'https?://(?:[a-zA-Z0-9-]+\.)*gitlab(?:\.com|\.io|\.net)?/[^\s]*(?:\?[^\s]*)?';

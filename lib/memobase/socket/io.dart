...
Future<WebSocketCore> connectSoc(String url, {List<String>? protocols}) async => await WebsocketIO.connect(url);
...
class WebsocketIO implements WebSocketCore {
  ...
  static Future<WebsocketIO> connect(String url, {List<String>? protocols}) async {
